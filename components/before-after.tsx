            ...
            >
              <div className="flex items-stretch">
                ...
                <div className="flex items-center justify-center px-2">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-foreground text-background sm:h-10 sm:w-10">
                ...
                {/* After */}
                <div className="relative flex-1">
                  <div className="absolute right-3 top-3 z-10 rounded-md bg-primary px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-primary-foreground">
                    Nachher
                  </div>
                  <div className="aspect-[3/4] overflow-hidden bg-secondary">
                    <img
